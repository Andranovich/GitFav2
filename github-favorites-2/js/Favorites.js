...
//classe que vai criar a visualização e evetos do html
export class FavoritesView extends Favorites {
    ...
    createRow() {
        ...
        tr.innerHTML = `
        <td class="user">
            <img src="https://github.com/Andranovich.png" alt="imagem de Rodrigo">
            <a href="https://github.com/Andranovich" target="_blank">
                <p>Rodrigo Andrade</p>
                <span>Andranovich</span>
            </a>
        </td>
